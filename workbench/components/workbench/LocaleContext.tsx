...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    referenceGoal: "示范动作：", referenceListenFor: "留意这个变化：",
    referencePreparing: "准备动作示范…", referencePreparingHelp: "正在安排示范、生成声音并检查目标动作。",
    referenceRetry: "重新准备示范", referenceTryAgain: "听不出动作？重新生成",
    referenceConfigMissing: "示范暂未配置好，仍可回听原音并按提示练习。",
    referenceMissingTarget: "这条建议缺少具体动作，暂时无法生成示范。",
    reference_unsupported_action: "目前还无法针对这个动作生成可靠示范。",
    reference_check_failed: "这次生成的声音未通过目标动作检查，暂不作为示范播放。",
    reference_check_unavailable: "这次未能完成声音检查，暂不作为示范播放。",
    referenceFallback: "可以继续回听原音、按动作提示试说，或结束这次练习。",
    referenceCheckNote: "这是经过 AI 声音检查的尝试性示范，仍可能不准确。请与原音一起回听，不必模仿音色。",
    ...
    top: "重点", candidate: "候选", highEvidence: "高证据", mediumEvidence: "中证据", listenerEffect: "听者可能在哪里费力", clearerVersion: "一种更清楚的表达", suggestionNote: "不是唯一正确答案，也不要求消除口音。", practiceThis: "练这一句", reference: "听动作示范", generating: "生成中…", referenceAudio: "参考表达音频",
  ...
  en: {
    referenceGoal: "Practice action:", referenceListenFor: "Listen for:",
    referencePreparing: "Preparing the demonstration…", referencePreparingHelp: "Planning, generating and checking the practice action in the audio.",
    referenceRetry: "Prepare again", referenceTryAgain: "Cannot hear the action? Generate again",
    referenceConfigMissing: "Demonstrations are not configured yet. You can still replay your recording and practise the cue.",
    referenceMissingTarget: "This suggestion needs a specific action before a demonstration can be generated.",
    reference_unsupported_action: "A reliable demonstration of this action is not available yet.",
    reference_check_failed: "The generated audio did not pass the practice-action check, so it is not presented as a demonstration.",
    reference_check_unavailable: "The audio check could not finish, so this audio is not presented as a demonstration.",
    referenceFallback: "Replay your recording, try the practice cue, or finish this session.",
    referenceCheckNote: "This is an experimental demonstration checked by AI and may still be inaccurate. Compare with your recording; you do not need to imitate its voice.",
